...
const ISSUE_TITLES: Record<string, string> = {
  'lesson1-basics': 'Lesson 1',
  'lesson2-agents': 'Lesson 2',
...
export default function Comments({ courseSlug, courseTitle }: CommentsProps) {
    ...
    async function fetchIssues() {
      ...
      try {
        ...
        const response = await fetch(
          `https://api.github.com/repos/zackzhangkai/claudecode-course-website/issues?state=all&per_page=10`,
          {
            headers: {
  ...
  const handleComment = () => {
    const repo = 'zackzhangkai/claudecode-course-website'
