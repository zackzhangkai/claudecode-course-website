...
This is a **Next.js 14 static export website** for the Claude Code 7 Days training course. It renders Markdown lessons as static pages with GitHub Issues-based comments.
...
- **Build dir**: `out/` (deployed to Vercel and Cloudflare Pages)
...
- **Customizations**: Code blocks (dark bg), blockquotes (purple border), tables, links

### Comments System
- Uses GitHub Issues as the comment backend
- Each lesson maps to a GitHub issue label via `ISSUE_TITLES` in `Comments.tsx`
- Issues created in: `zackzhangkai/claudecode-course-website`
- Client-side fetching from GitHub API (unauthenticated, rate limited)

### Deployment
- **Platforms**: Vercel and Cloudflare Pages
- **Vercel URL**: https://claudecode-7days.vercel.app
- **Cloudflare URL**: https://claudecode-7days.pages.dev
